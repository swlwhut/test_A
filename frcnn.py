...
class FRCNN(object):
    _defaults = {
        ...
        #--------------------------------------------------------------------------#
        #"model_path"    : 'model_data/ep015-loss0.988-val_loss1.317.pth',
        #"model_path"    : 'model_data/ep020-loss0.857-val_loss0.989.pth',
        #"model_path"    : 'model_data/ep027-loss1.149-val_loss1.144.pth',
        "model_path"    : 'model_data/ep045-loss1.077-val_loss1.086.pth',
    ...
    #   检测图片
    #---------------------------------------------------#
    def detect_image(self, image, crop = True):
        #---------------------------------------------------#
        #   计算输入图片的高和宽
        #---------------------------------------------------#
        ...
        if crop:
            for i, c in list(enumerate(top_label)):
                ...
                if c == 2:
                    ...
                    crop_image.save(os.path.join(dir_save_path, "crop_" + str(i) + ".png"), quality=100, subsampling=0)
